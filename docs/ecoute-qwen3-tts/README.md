# Jeu d'écoute — les voix de BATE

Les clips qui documentent les décisions **encore en vigueur**, et les deux choix qui attendent
une oreille : les six âges d'Arthur (lot 8) et le casting de Tessia (lot 9).
Verdicts et mesures : [`../qwen3-tts.md`](../qwen3-tts.md).
    ...
    bash docs/ecoute-qwen3-tts/ecouter.sh 5    # ⚠ les 4 candidates de Tessia — À TRANCHER
...
| `9-casting-tessia/` | **⚠ à trancher** — les 4 timbres féminins ([détail](9-casting-tessia/README.md)) |
